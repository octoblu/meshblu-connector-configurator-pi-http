...
class MeshbluConnectorConfigurator {
  constructor({ connectorHome, pm2Home, serialNumber }) {
  ...
  configurate() {
    return axios.get(`https://s3-us-west-2.amazonaws.com/genisys-automatic-configuration/pis/${this.serialNumber}/configuration.json`)
